...
import { Search, Users, Shield, Activity, RefreshCw, Eye, Database, AlertTriangle } from "lucide-react"
      ...
      <Tabs defaultValue="users" className="mb-6" value={activeTab} onValueChange={(value) => setActiveTab(value)}>
        ...
        <TabsContent value="system">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {/* Database Management */}
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm dark:bg-[#0c0c14] dark:border-[#1e1e2f]">
              <div className="mb-4">
                <h3 className="text-xl font-bold">Database Management</h3>
                <p className="text-sm text-muted-foreground">Manage database and migrations</p>
              </div>

              <div className="mb-4 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Database Status:</span>
                  <span className="rounded-full bg-[#1e1e2f] px-2 py-0.5 text-xs">Unknown</span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="space-y-2">
                <Button
                  variant="outline"
                  className="w-full justify-center dark:bg-[#0c0c14] dark:border-[#1e1e2f] dark:hover:bg-[#1e1e2f]"
            ...
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm dark:bg-[#0c0c14] dark:border-[#1e1e2f]">
              <div className="mb-4">
                <h3 className="text-xl font-bold">Authentication Systems</h3>
                <p className="text-sm text-muted-foreground">Fix auth related issues</p>
              </div>

              <div className="mb-4 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Verification System:</span>
                  <span className="rounded-full bg-[#1e1e2f] px-2 py-0.5 text-xs">Not Configured</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Password Reset System:</span>
                  <span className="rounded-full bg-[#1e1e2f] px-2 py-0.5 text-xs">Active</span>
                </div>
              </div>
            ...
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm dark:bg-[#0c0c14] dark:border-[#1e1e2f]">
              <div className="mb-4">
                <h3 className="text-xl font-bold">Notification Services</h3>
                <p className="text-sm text-muted-foreground">Manage email and SMS services</p>
              </div>
            ...
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm dark:bg-[#0c0c14] dark:border-[#1e1e2f]">
              <div className="mb-4">
                ...
                <p className="text-sm text-muted-foreground">Debug and repair tools</p>
              </div>
            ...
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm dark:bg-[#0c0c14] dark:border-[#1e1e2f]">
              <div className="mb-4">
                ...
                <p className="text-sm text-muted-foreground">Additional administrative tools</p>
              </div>
