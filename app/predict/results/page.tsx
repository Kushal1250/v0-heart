...
export default function ResultsPage() {
  ...
  const pdfFileName = `health-assessment-${result.result.risk}-risk-${new Date().toISOString().split("T")[0]}`
  ...
  const handleMobilePdfShare = async () => {
    try {
      ...
      // Add risk score
      pdf.setFontSize(14)
      pdf.text(`Risk Score: ${result.result.score}%`, 20, 55)
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {isMobile && showShareOptions && (
          <div className="mb-6 flex flex-wrap gap-2 justify-center">
            <EmailShareModal assessmentData={result} />
            <PdfGenerator contentRef={resultContentRef} fileName={pdfFileName} />
            <Button
              variant="outline"
        ...
        >
          ...
          <CardContent className={`${isMobile ? "p-4" : "pt-6"}`}>
            ...
            <div className="mb-6">
              <h3 className="text-base md:text-lg font-semibold mb-3">Additional Health Metrics:</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3">
                ...
                <div className="bg-gray-800/50 p-2 md:p-3 rounded-md">
                  ...
                  <p className="text-sm md:text-base font-medium">{result.oldpeak}</p>
                </div>
              </div>
            </div>
        ...
        {!isMobile && (
          <div className="mt-6 space-y-6">
            <DirectShareOptions assessmentData={result} />
