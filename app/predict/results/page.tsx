      ...
      <div className="max-w-3xl mx-auto">
        ...
        {isMobile && showShareOptions && (
          <div className="mb-6 flex flex-wrap gap-2 justify-center">
            <EmailShareModal assessmentData={result} userName={user?.name} assessmentDate={assessmentDate} />
            <PdfGenerator
        ...
        {!isMobile && (
          <div className="mt-6 space-y-6">
            <DirectShareOptions assessmentData={result} userName={user?.name} assessmentDate={assessmentDate} />
