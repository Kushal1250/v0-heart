...
// This is a server component version of the footer without media queries
    ...
    <footer className="bg-[#0d1524] text-white py-12 border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/company/press" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Press Releases
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-sm mb-4">© 2024 HeartCare. All rights reserved.</p>
